...
static uint8_t rFE96_setting[8] = { 0xB4, 0x64, 0x3F, 0x3F, 0x3C, 0x00, 0x3C, 0x00}; //add by Joan for init self_test FE96

static int self_test_delay_time = 3; //add by Joan for init self_test delay time(s)
...
static bool	fw_update_OK = false;
